...
// --- HENDRY-SPECIFIC BROWSER SETUP FOR STEALTH ---
...
export async function runHendry() {
  ...
  console.log('═══════════════════════════════════════');
  console.log('🚦 Starting Hendry County Scraper (Stealth Mode)');
  console.log('═══════════════════════════════════════');
  ...
  try {
    ...
    // Keep the CAPTCHA check as a safety fallback
    ...
    for (let i = 0; i < detailUrls.length; i++) {
      ...
      try {
        // Increased delay for more discretion (from 1000/400 to 2000/1000)
