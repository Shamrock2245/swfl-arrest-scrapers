...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run Pinellas County scraper')
    parser.add_argument('days_back', nargs='?', type=int, default=7, help='Number of days back to scrape (default: 7)')
