// fix_hendry_headers.js
// Fix the headers in the Hendry sheet to match the schema
...
async function fixHendryHeaders() {
  console.log('🔧 Fixing Hendry sheet headers...\n');
  ...
  try {
    ...
    // Clear existing data
    console.log('🗑️  Clearing existing Hendry data...');
    ...
    console.log('\n✅ Headers fixed! The Hendry sheet is now ready.');
